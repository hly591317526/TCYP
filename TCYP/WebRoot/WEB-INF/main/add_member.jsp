...
<body
	...
	<div class="container">
		<h1
			style="cursor: default; padding-top: 0; color: white; font-size:40px;">Management-New</h1>
		<nav>
		<ul>
	...
	<h1 style="color:white; margin-left: 40%;">New Member</h1>
	<div class="login-form">
		...
		<form action="addMember.do" method="post"
			...
			<br /> <br /> <input type="radio" name="memberType" value='0'
				checked="checked" id="member" /><span
				style="color:white;font-size:20px; font-weight: bold;">
				会员&nbsp;&nbsp;&nbsp;&nbsp;</span> <input type="radio" name="memberType"
				value='1' id="manager" /><span
				style="color:red;font-size:20px; font-weight: bold;"> 管理员</span> <br />
			<input type="submit" value="注册" style="height: 60px;" />
		</form>
	</div>
	<br />
	<br />
